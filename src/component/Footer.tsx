...
const Footer: FC<FooterProps> = ({ admin }) => {
  return admin ? (
    <div className="lg:ml-72 px-6 mt-3 text-[#67748e] text-sm z-50">
      © 2023, made with 💖 by <span className="text-slate-700 font-semibold">Denson Patibang</span> for a better web.
    </div>
  ) : (
    <div className="bg-[#0a348c] lg:px-44 px-4 py-10 bg-footerImage bg-contain bg-center bg-no-repeat text-white ">
      <div className="flex flex-col gap-6 lg:grid lg:grid-cols-4">
        ...
        <div>
          ...
          <p className="font-thin text-sm mt-3 tracking-widest">
            <i className="fa-solid fa-phone"></i> Sekretaris : Hardianto
            Tandiseno
            <br />
            <div className="mt-3">
              <Link to="https://wa.me/6282346484775">( 082346484775 )</Link>
